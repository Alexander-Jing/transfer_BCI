...
export result_save_rootdir="$YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/OursT_1_pre/binary/$scenario/$bucket" 
export n_epoch=60
export restore_file="None"

if [[ $ACTION_NAME == "submit" ]]; then
    ## Use this line to submit the experiment to the batch scheduler
    sbatch < $YOUR_PATH/fNIRS-mental-workload-classifiers/generic_models/runs/do_experiment_OursT.slurm
