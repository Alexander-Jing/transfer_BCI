...
do
    ...
    do
        ...
        do
            ...
            export experiment_dir="$YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/RandomForest/four_class/$scenario/$TestBucket/$SubjectId_of_interest"
            
            echo "Current experiment_dir is $experiment_dir"
            
            ## NOTE all env vars that have been 'export'-ed will be passed along to the .slurm file
            
            bash $YOUR_PATH/fNIRS-mental-workload-classifiers/synthesizing_results/generic_models/binary/RandomForest/synthesize_hypersearch_RF_for_a_subject.slurm
