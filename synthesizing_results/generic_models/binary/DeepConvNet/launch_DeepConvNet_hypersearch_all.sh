...
do
    ...
    do
        ...
        do
            ...
            export experiment_dir="$YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_models/DeepConvNet/binary/$scenario/$TestBucket/$SubjectId_of_interest"
