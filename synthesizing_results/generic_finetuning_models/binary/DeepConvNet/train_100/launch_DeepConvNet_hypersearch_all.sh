...
do
    ...
    do
        ...
        do
            ...
            export experiment_dir="$YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_finetuning_models/DeepConvNet/binary/train_100/$scenario/$TestBucket/$SubjectId_of_interest"
