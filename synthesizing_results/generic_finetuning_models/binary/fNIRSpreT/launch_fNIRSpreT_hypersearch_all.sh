...
do
    ...
    do
        ...
        do
            ...
            export experiment_dir="$YOUR_PATH/fNIRS-mental-workload-classifiers/experiments/generic_finetuning_models/fNIRSpreT/binary/train_100/$scenario/$TestBucket/$SubjectId_of_interest"
            
            echo "Current experiment_dir is $experiment_dir"
            
            ## NOTE all env vars that have been 'export'-ed will be passed along to the .slurm file
            
            bash $YOUR_PATH/fNIRS-mental-workload-classifiers/synthesizing_results/generic_models/binary/fNIRSpreT/synthesize_hypersearch_fNIRSpreT_for_a_subject.slurm
